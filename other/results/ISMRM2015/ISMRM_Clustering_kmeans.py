...
def main():
    ...
    n_clusters = [1000, 3720, 10000, 100000]
    start = time.time()
    ...
    for _, c in enumerate(n_clusters):
        ...
        clusters_out_file = out_folder + '/ISMRM_GT_'+str(c)+'clusters'
        output_recTCK_path = out_folder + '/ISMRM_GT_'+str(c)+'clusters_rectTCK.tck'
