...
def main():
    ...
    for _, thr in enumerate(thrs):
        ...
        clusters_out_file = out_folder + '/newClustering_ISMRM_GT_centers_thr'+str(thr)
        output_recTCK_path = out_folder + '/newClustering_ISMRM_GT_centers_thr'+str(thr)+'_rectTCK.tck'
