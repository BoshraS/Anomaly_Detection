...
def main():
    ...
    for _, thr in enumerate(thrs):
        ...
        clusters_out_file = 'FiberCup_GT_Clusters/NewClustering/newClustering_FiberCup_centers_thr'+str(thr)
    ...
    for _, thr in enumerate(thrs):
        output_recTCK_path = 'FiberCup_GT_Clusters/NewClustering/FiberCup_GT_new_thr'+str(thr)+'_clusters_rectTCK.tck'
        cluster_centers_path = 'FiberCup_GT_Clusters/NewClustering/newClustering_FiberCup_centers_thr'+str(thr)
